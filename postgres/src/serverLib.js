...
import PrismaLocal from './lib/prisma.js';
class ServerLib {
    constructor() {
        // State
        this.app = express();
    ...
    async start() {
        try {
            ...
            // Run the prisma example code
            console.log('Running Prisma example code');
            const prisma = new PrismaLocal();
            await prisma.runQueries();
